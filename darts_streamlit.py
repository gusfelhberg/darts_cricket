...
def new_game(turns, board, current_score, darts_to_finish, max_poss_scoring, fewer_remaining, game_end, completed, scoring, highest_score, triples, doubles, dartm, dartn, entryscore):
...
if __name__=="__main__":
    ...
    if main_bt == True:
        ...
        new_game(turns, board, current_score, darts_to_finish, max_poss_scoring, fewer_remaining, game_end, completed, scoring, highest_score, triples, doubles, dartm, dartn, entryscore)
        
        del turns
        del board
        del current_score
        del darts_to_finish
        del max_poss_scoring
        del fewer_remaining
        del game_end
        del completed
        del scoring
